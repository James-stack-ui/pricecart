...
public final class FragmentLoginBinding implements ViewBinding {
  ...
  private FragmentLoginBinding(@NonNull ScrollView rootView,
      ...
      @NonNull MaterialButton loginButton, @NonNull TextView loginMessageTextView,
      @NonNull ProgressBar loginProgressBar, @NonNull TextInputEditText passwordEditText,
      @NonNull TextInputLayout passwordInputLayout, @NonNull TextView registerLinkTextView) {
    ...
    this.registerLinkTextView = registerLinkTextView;
  }
  ...
  public static FragmentLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.registerLinkTextView;
      TextView registerLinkTextView = ViewBindings.findChildViewById(rootView, id);
      if (registerLinkTextView == null) {
        break missingId;
      }

      return new FragmentLoginBinding((ScrollView) rootView, emailEditText, emailInputLayout,
          loginButton, loginMessageTextView, loginProgressBar, passwordEditText,
          passwordInputLayout, registerLinkTextView);
    }
